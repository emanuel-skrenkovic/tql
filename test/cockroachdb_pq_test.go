...
func Test_CockroachDB_pq_QueryFirstOrDefault_Returns_First_Result(t *testing.T) {
	...
	_, err := cockroachDB.Exec(fmt.Sprintf("INSERT INTO test VALUES ('%s', '%s');", id.String(), nullable.String()))
...
func Test_CockroachDB_pq_QueryOne(t *testing.T) {
	...
	// Act
	r, err := tql.QueryFirst[result](context.Background(), cockroachDB, "SELECT id, nullable FROM test WHERE id = $1;", id)
...
func Test_CockroachDB_pq_QueryOne_With_Named_Parameters(t *testing.T) {
	...
	_, err := cockroachDB.Exec(fmt.Sprintf("INSERT INTO test (id, nullable) VALUES ('%s', '%s');", id.String(), nullable.String()))
	require.NoError(t, err)
...
func Test_CockroachDB_pq_QueryOne_String(t *testing.T) {
	...
	// Act
	r, err := tql.QueryFirst[string](context.Background(), cockroachDB, "SELECT id FROM test WHERE id = $1;", id)
...
func Test_CockroachDB_pq_QueryOne_Int_Pointer(t *testing.T) {
	...
	// Act
	r, err := tql.QueryFirst[*int](context.Background(), cockroachDB, "SELECT 420;")
...
func Test_CockroachDB_pq_Query(t *testing.T) {
	...
	_, err := cockroachDB.Exec("DELETE FROM test;")
	require.NoError(t, err)
	...
	_, err = cockroachDB.Exec(insertStmt, ids...)
	require.NoError(t, err)

	// Act
	r, err := tql.Query[result](context.Background(), cockroachDB, "SELECT id, nullable FROM test;")
...
func Test_CockroachDB_pq_Query_Basic_Type_From_Tx(t *testing.T) {
	...
	_, err = cockroachDB.Exec(insertStmt, id, nullable)
	require.NoError(t, err)

	tx, _ := cockroachDB.BeginTx(context.Background(), &sql.TxOptions{})
...
func Test_CockroachDB_pq_Query_Basic_Type_Pointer(t *testing.T) {
	...
	// Act
	r, err := tql.QueryFirst[*string](context.Background(), cockroachDB, "SELECT id FROM test;")
...
func Test_CockroachDB_pq_Query_Basic_Type_Pointer_Null(t *testing.T) {
	...
	// Act
	r, err := tql.QueryFirst[*string](context.Background(), cockroachDB, "SELECT NULL;")
...
func Test_CockroachDB_pq_Query_Empty_Result(t *testing.T) {
	...
	_, err := cockroachDB.Exec("INSERT INTO test VALUES ('asdf', 'fdsa');")
	require.NoError(t, err)

	// Act
	r, err := tql.Query[result](context.Background(), cockroachDB, "SELECT * FROM test WHERE id = '';")
...
func Test_CockroachDB_pq_Exec(t *testing.T) {
	...
	_, err := tql.Exec(context.Background(), cockroachDB, insertStmt, map[string]any{
		"test":  "totally_new_id",
	...
	// Assert
	require.NoError(t, err)
	r, err := tql.QueryFirst[result](context.Background(), cockroachDB, "SELECT * FROM test WHERE id = $1;", "totally_new_id")
...
func Test_CockroachDB_pq_Exec_With_Struct(t *testing.T) {
	...
	const insertStmt = "INSERT INTO test (id, nullable) VALUES (:test, :test2);"
	_, err := tql.Exec(context.Background(), cockroachDB, insertStmt, params)

	// Assert
	require.NoError(t, err)
	r, err := tql.QueryFirst[result](context.Background(), cockroachDB, "SELECT * FROM test WHERE id = $1;", id)
...
func Test_CockroachDB_pq_Exec_Not_Named(t *testing.T) {
	...
	// Act
	_, err := tql.Exec(context.Background(), cockroachDB, insertStmt, id, userID)
...
func Test_CockroachDB_pq_Exec_Mixed_Named_Positional(t *testing.T) {
	...
	_, err := tql.Exec(context.Background(), cockroachDB, insertStmt, id, userID, map[string]any{"test2": "asdf"})
